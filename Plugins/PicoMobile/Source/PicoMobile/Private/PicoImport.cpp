...
DLL_DEFINE(PvrSetRefreshRate);
DLL_DEFINE(PvrGetRefreshRate);
DLL_DEFINE(PvrSetDisplayFrequency);
DLL_DEFINE(PvrGetDisplayFrequenciesAvailable);
DLL_DEFINE(PvrSetColorspaceType);
...
bool PicoImport::Init()
{
	...
	if (GSharedLibraryHandle != NULL)
	{
		...
		PvrSetColorspaceType = (FDllPvrSetColorspaceTypeProc)dlsym(GSharedLibraryHandle, "Pvr_SetColorspaceType");
		if (!PvrSetColorspaceType) UE_LOG(LogPicoImport, Warning, TEXT("PVR_setPerformanceLevels not found!"));
		...
		PvrSetRefreshRate = (FDllPvrSetRefreshRateProc)dlsym(GSharedLibraryHandle, "Pvr_SetRefreshRate");
		if (!PvrSetRefreshRate) UE_LOG(LogPicoImport, Warning, TEXT("PvrSetRefreshRate not found!"));

		PvrGetRefreshRate = (FDllPvrGetRefreshRateProc)dlsym(GSharedLibraryHandle, "Pvr_GetRefreshRate");
		if (!PvrGetRefreshRate) UE_LOG(LogPicoImport, Warning, TEXT("PvrGetRefreshRate not found!"));

		PvrSetDisplayFrequency = (FDllPvrSetDisplayFrequencyProc)dlsym(GSharedLibraryHandle, "Pvr_SetDisplayFrequency");
		if (!PvrSetDisplayFrequency) UE_LOG(LogPicoImport, Warning, TEXT("PvrSetDisplayFrequency not found!"));

		PvrGetDisplayFrequenciesAvailable = (FDllPvrGetDisplayFrequenciesAvailableProc)dlsym(GSharedLibraryHandle, "Pvr_GetDisplayFrequenciesAvailable");
		if (!PvrGetDisplayFrequenciesAvailable) UE_LOG(LogPicoImport, Warning, TEXT("PvrGetDisplayFrequenciesAvailable not found!"));
		return true;
	}
	return false;
}
...
void PicoSDK::Render::GetRefreshRate(float& rate)
{
#if PLATFORM_ANDROID
	PicoImport::PvrGetRefreshRate(rate);
#endif
}

void PicoSDK::Render::SetRefreshRate(float rate)
{
#if PLATFORM_ANDROID
	PicoImport::PvrSetRefreshRate(rate);
#endif
}

void PicoSDK::Render::SetDisplayFrequency(float rate)
{
#if PLATFORM_ANDROID
	PicoImport::PvrSetDisplayFrequency(rate);
#endif
}

void PicoSDK::Render::GetDisplayFrequenciesAvailable(float rate[], int length)
{
#if PLATFORM_ANDROID
	PicoImport::PvrGetDisplayFrequenciesAvailable(rate,length);
#endif
}
