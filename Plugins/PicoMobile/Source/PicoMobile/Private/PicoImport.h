...
typedef void(*FDllPvrSetColorspaceTypeProc)(int32 colorspaceType);
//Foveation
...
//SystemRefreshRates
typedef int32(*FDllPvrSetRefreshRateProc)(float rate);
typedef int32(*FDllPvrGetRefreshRateProc)(float &rate);
typedef int32(*FDllPvrSetDisplayFrequencyProc)(float rate);
typedef int32(*FDllPvrGetDisplayFrequenciesAvailableProc)(float rate[],int length);
...
public:
	...
	static FDllPvrSetColorspaceTypeProc PvrSetColorspaceType;
	...
	//SystemRefreshRates
	static FDllPvrSetRefreshRateProc PvrSetRefreshRate;
	static FDllPvrGetRefreshRateProc PvrGetRefreshRate;
	static FDllPvrSetDisplayFrequencyProc PvrSetDisplayFrequency;
	static FDllPvrGetDisplayFrequenciesAvailableProc PvrGetDisplayFrequenciesAvailable;
...
public:
	...
	public:
		...
		static void GetRefreshRate(float &rate);
		static void SetRefreshRate(float rate);
		static void SetDisplayFrequency(float rate);
		static void GetDisplayFrequenciesAvailable(float rate[],int length);
	public:
