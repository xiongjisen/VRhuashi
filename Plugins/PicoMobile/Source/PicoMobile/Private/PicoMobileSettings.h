...
public:
	...
	UPROPERTY(Config, EditAnywhere, Category = "PicoMobile", Meta = (DisplayName = "Display Refresh Rates", ToolTip = "Set the system display refresh rates"))
		TEnumAsByte<ERefreshRate::Type> refreshRate;

	UPROPERTY(Config, EditAnywhere, Category = "PicoMobile", Meta = (DisplayName = "Use Recommended MSAA Level"))
		bool bUseRecommendedMSAA;

	UPROPERTY(Config, EditAnywhere, Category = "PicoMobile", Meta = (DisplayName = "Use SRGB Encoding"))
