...
FMatrix FPicoVRStereoLayer::GetLayerMV(FQuat CamOri, FVector CamPos, bool& fixedOverLay,FTransform TrackingToWorld)
{
	...
	mModelLocation =  TrackingToWorld.InverseTransformPosition(Desc.Transform.GetLocation());
	mModelRotation = TrackingToWorld.GetRotation() * Desc.Transform.GetRotation();
