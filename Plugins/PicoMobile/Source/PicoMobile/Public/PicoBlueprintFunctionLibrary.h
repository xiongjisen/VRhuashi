...
DECLARE_DYNAMIC_DELEGATE_OneParam(FPicoDisplayRefreshRateDelegate, float, rate);
...
public:
	...
	static FPicoDisplayRefreshRateDelegate PicoDisplayRefreshRateCallback;
public:
	// Sensor
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = "PicoMobile")
		static void PicoSetRefreshRate(EPicoRefreshRate rate);
	UFUNCTION(BlueprintCallable, Category = "PicoMobile")
		static void PicoGetRefreshRate(EPicoRefreshRate &rate);
	UFUNCTION(BlueprintCallable, Category = "PicoMobile")
		static void PicoDisplayRefreshRateChangedDelegates(FPicoDisplayRefreshRateDelegate OnPicoDisplayRefreshRateChanged);
