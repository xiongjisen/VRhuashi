...
// Cross Module References
	PICOMOBILE_API UEnum* Z_Construct_UEnum_PicoMobile_ERefreshRate();
...
// End Cross Module References
	static UEnum* ERefreshRate_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_PicoMobile_ERefreshRate, Z_Construct_UPackage__Script_PicoMobile(), TEXT("ERefreshRate"));
		}
		return Singleton;
	}
	template<> PICOMOBILE_API UEnum* StaticEnum<ERefreshRate::Type>()
	{
		return ERefreshRate_StaticEnum();
	}
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ERefreshRate(ERefreshRate_StaticEnum, TEXT("/Script/PicoMobile"), TEXT("ERefreshRate"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_PicoMobile_ERefreshRate_Hash() { return 2861220969U; }
	UEnum* Z_Construct_UEnum_PicoMobile_ERefreshRate()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_PicoMobile();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("ERefreshRate"), 0, Get_Z_Construct_UEnum_PicoMobile_ERefreshRate_Hash(), false);
#else
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPicoMobileSettings_Statics::NewProp_refreshRate_MetaData[] = {
		{ "Category", "PicoMobile" },
		{ "DisplayName", "Display Refresh Rates" },
		{ "ModuleRelativePath", "Private/PicoMobileSettings.h" },
		{ "ToolTip", "Set the system display refresh rates" },
	};
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UPicoMobileSettings_Statics::NewProp_refreshRate = { "refreshRate", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPicoMobileSettings, refreshRate), Z_Construct_UEnum_PicoMobile_ERefreshRate, METADATA_PARAMS(Z_Construct_UClass_UPicoMobileSettings_Statics::NewProp_refreshRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPicoMobileSettings_Statics::NewProp_refreshRate_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPicoMobileSettings_Statics::NewProp_bUseRecommendedMSAA_MetaData[] = {
		{ "Category", "PicoMobile" },
		{ "DisplayName", "Use Recommended MSAA Level" },
		{ "ModuleRelativePath", "Private/PicoMobileSettings.h" },
	};
#endif
	void Z_Construct_UClass_UPicoMobileSettings_Statics::NewProp_bUseRecommendedMSAA_SetBit(void* Obj)
	{
		((UPicoMobileSettings*)Obj)->bUseRecommendedMSAA = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPicoMobileSettings_Statics::NewProp_bUseRecommendedMSAA = { "bUseRecommendedMSAA", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UPicoMobileSettings), &Z_Construct_UClass_UPicoMobileSettings_Statics::NewProp_bUseRecommendedMSAA_SetBit, METADATA_PARAMS(Z_Construct_UClass_UPicoMobileSettings_Statics::NewProp_bUseRecommendedMSAA_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPicoMobileSettings_Statics::NewProp_bUseRecommendedMSAA_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPicoMobileSettings_Statics::NewProp_bUseHWsRGBEncoding_MetaData[] = {
		{ "Category", "PicoMobile" },
		{ "DisplayName", "Use SRGB Encoding" },
		{ "ModuleRelativePath", "Private/PicoMobileSettings.h" },
	};
#endif
	void Z_Construct_UClass_UPicoMobileSettings_Statics::NewProp_bUseHWsRGBEncoding_SetBit(void* Obj)
	{
		((UPicoMobileSettings*)Obj)->bUseHWsRGBEncoding = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPicoMobileSettings_Statics::NewProp_bUseHWsRGBEncoding = { "bUseHWsRGBEncoding", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UPicoMobileSettings), &Z_Construct_UClass_UPicoMobileSettings_Statics::NewProp_bUseHWsRGBEncoding_SetBit, METADATA_PARAMS(Z_Construct_UClass_UPicoMobileSettings_Statics::NewProp_bUseHWsRGBEncoding_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPicoMobileSettings_Statics::NewProp_bUseHWsRGBEncoding_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UPicoMobileSettings_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPicoMobileSettings_Statics::NewProp_refreshRate,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPicoMobileSettings_Statics::NewProp_bUseRecommendedMSAA,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPicoMobileSettings_Statics::NewProp_bUseHWsRGBEncoding,
	...
	IMPLEMENT_CLASS(UPicoMobileSettings, 2197824597);
