...
// End Cross Module References
	...
	DEFINE_FUNCTION(UPicoNeoControllerBPlib::execPicoSetControllerOriginOffset)
	{
		P_GET_PROPERTY(FIntProperty,Z_Param_hand);
		P_GET_STRUCT(FVector,Z_Param_offset);
		P_FINISH;
		P_NATIVE_BEGIN;
		UPicoNeoControllerBPlib::PicoSetControllerOriginOffset(Z_Param_hand,Z_Param_offset);
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(UPicoNeoControllerBPlib::execGetSubControllerBatteryLevel)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(bool*)Z_Param__Result=UPicoNeoControllerBPlib::GetSubControllerBatteryLevel(Z_Param_Out_Power);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UPicoNeoControllerBPlib::execGetMainControllerBatteryLevel)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(bool*)Z_Param__Result=UPicoNeoControllerBPlib::GetMainControllerBatteryLevel(Z_Param_Out_Power);
		P_NATIVE_END;
	}
	...
	void UPicoNeoControllerBPlib::StaticRegisterNativesUPicoNeoControllerBPlib()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "PicoSetControllerOriginOffset", &UPicoNeoControllerBPlib::execPicoSetControllerOriginOffset },
	...
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UPicoNeoControllerBPlib_GetMainControllerBatteryLevel_Statics::NewProp_Power = { "Power", nullptr, (EPropertyFlags)0x0010000000000180, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PicoNeoControllerBPlib_eventGetMainControllerBatteryLevel_Parms, Power), METADATA_PARAMS(nullptr, 0) };
	void Z_Construct_UFunction_UPicoNeoControllerBPlib_GetMainControllerBatteryLevel_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
		((PicoNeoControllerBPlib_eventGetMainControllerBatteryLevel_Parms*)Obj)->ReturnValue = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UPicoNeoControllerBPlib_GetMainControllerBatteryLevel_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(PicoNeoControllerBPlib_eventGetMainControllerBatteryLevel_Parms), &Z_Construct_UFunction_UPicoNeoControllerBPlib_GetMainControllerBatteryLevel_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPicoNeoControllerBPlib_GetMainControllerBatteryLevel_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPicoNeoControllerBPlib_GetMainControllerBatteryLevel_Statics::NewProp_Power,
	...
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UPicoNeoControllerBPlib_GetSubControllerBatteryLevel_Statics::NewProp_Power = { "Power", nullptr, (EPropertyFlags)0x0010000000000180, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PicoNeoControllerBPlib_eventGetSubControllerBatteryLevel_Parms, Power), METADATA_PARAMS(nullptr, 0) };
	void Z_Construct_UFunction_UPicoNeoControllerBPlib_GetSubControllerBatteryLevel_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
		((PicoNeoControllerBPlib_eventGetSubControllerBatteryLevel_Parms*)Obj)->ReturnValue = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UPicoNeoControllerBPlib_GetSubControllerBatteryLevel_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(PicoNeoControllerBPlib_eventGetSubControllerBatteryLevel_Parms), &Z_Construct_UFunction_UPicoNeoControllerBPlib_GetSubControllerBatteryLevel_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPicoNeoControllerBPlib_GetSubControllerBatteryLevel_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPicoNeoControllerBPlib_GetSubControllerBatteryLevel_Statics::NewProp_Power,
	...
	struct Z_Construct_UFunction_UPicoNeoControllerBPlib_PicoSetControllerOriginOffset_Statics
	{
		struct PicoNeoControllerBPlib_eventPicoSetControllerOriginOffset_Parms
		{
			int32 hand;
			FVector offset;
		};
		static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_hand;
	...
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UFunction_UPicoNeoControllerBPlib_PicoSetControllerOriginOffset_Statics::NewProp_hand = { "hand", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PicoNeoControllerBPlib_eventPicoSetControllerOriginOffset_Parms, hand), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPicoNeoControllerBPlib_PicoSetControllerOriginOffset_Statics::NewProp_offset = { "offset", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PicoNeoControllerBPlib_eventPicoSetControllerOriginOffset_Parms, offset), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPicoNeoControllerBPlib_PicoSetControllerOriginOffset_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPicoNeoControllerBPlib_PicoSetControllerOriginOffset_Statics::NewProp_hand,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPicoNeoControllerBPlib_PicoSetControllerOriginOffset_Statics::NewProp_offset,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPicoNeoControllerBPlib_PicoSetControllerOriginOffset_Statics::Function_MetaDataParams[] = {
		{ "Category", "Pico Neo|Controller" },
		{ "ModuleRelativePath", "Public/PicoNeoControllerBPlib.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UPicoNeoControllerBPlib_PicoSetControllerOriginOffset_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPicoNeoControllerBPlib, nullptr, "PicoSetControllerOriginOffset", nullptr, nullptr, sizeof(PicoNeoControllerBPlib_eventPicoSetControllerOriginOffset_Parms), Z_Construct_UFunction_UPicoNeoControllerBPlib_PicoSetControllerOriginOffset_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPicoNeoControllerBPlib_PicoSetControllerOriginOffset_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04822401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UPicoNeoControllerBPlib_PicoSetControllerOriginOffset_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UPicoNeoControllerBPlib_PicoSetControllerOriginOffset_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UPicoNeoControllerBPlib_PicoSetControllerOriginOffset()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UPicoNeoControllerBPlib_PicoSetControllerOriginOffset_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UPicoNeoControllerBPlib_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UPicoNeoControllerBPlib_GetMainControllerBatteryLevel, "GetMainControllerBatteryLevel" }, // 665285089
		{ &Z_Construct_UFunction_UPicoNeoControllerBPlib_GetNeoDeviceType, "GetNeoDeviceType" }, // 2945793196
		{ &Z_Construct_UFunction_UPicoNeoControllerBPlib_GetSubControllerBatteryLevel, "GetSubControllerBatteryLevel" }, // 2464987485
		...
		{ &Z_Construct_UFunction_UPicoNeoControllerBPlib_PicoSetControllerOriginOffset, "PicoSetControllerOriginOffset" }, // 3037043853
	...
	IMPLEMENT_CLASS(UPicoNeoControllerBPlib, 2686533004);
