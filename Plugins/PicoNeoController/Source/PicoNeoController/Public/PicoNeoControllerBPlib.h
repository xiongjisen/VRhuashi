...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Pico Neo|Controller")
		static bool GetMainControllerBatteryLevel(int32 &Power);

	UFUNCTION(BlueprintCallable, Category = "Pico Neo|Controller")
		static bool GetSubControllerBatteryLevel(int32& Power);
	...
	UFUNCTION(BlueprintCallable, Category = "Pico Neo|Controller")
		static void PicoSetControllerOriginOffset(int hand,FVector offset);
